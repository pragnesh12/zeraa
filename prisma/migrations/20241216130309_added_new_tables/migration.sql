...
-- CreateEnum
CREATE TYPE "IssuePriority" AS ENUM ('LOW', 'MEDIUM', 'FAST', 'URGENT');
...
-- AddForeignKey
ALTER TABLE "Issue" ADD CONSTRAINT "Issue_assigneId_fkey" FOREIGN KEY ("assigneId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
